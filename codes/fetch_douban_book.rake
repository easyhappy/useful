...
namespace :admin do
  task :fetch_douban_book => :environment do
    require 'typhoeus'
    require 'nokogiri'
    require 'pry'
    require 'csv'
    ...
    def main
      urls = [
              'http://book.douban.com/tag/%E4%BA%92%E8%81%94%E7%BD%91',
              'http://book.douban.com/tag/%E7%BC%96%E7%A8%8B',
              'http://book.douban.com/tag/%E4%BA%A4%E4%BA%92%E8%AE%BE%E8%AE%A1',
              'http://book.douban.com/tag/%E7%AE%97%E6%B3%95'
             ]
      fetch_handler = FetchHandler.new(urls)
      fetch_handler.run
    end
